...
<head>
	...
	function countdown(secs,elem)
	{
	 ...
	 if(secs<1)
	 {
		...
		element.innerHTML += '<form action="GetWinner" method="post"><input type="submit"   value="View Winner" class="area" size="40px"></form>';
	 }
    }
        	...
        	<div class="n-bordered td">
            	<table width="50%"align="center"   cellpadding="26%" >
				    ...
				    <tr>
						...
						<td>
							<form action="ViewBids" method="post"><input type="submit"  value="View Buyers" class="area" size="40px"></form>
						</td>
						<td>
							<form action="ViewPrice" method="post"><input type="submit"  value="View Sellers" class="area" size="40px"></form>
						</td>
