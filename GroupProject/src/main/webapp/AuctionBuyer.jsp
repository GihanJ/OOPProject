...
<head>
	...
	<script type= "text/javascript">
		...
		function countdown(secs,elem)
		{
			...
			{
				clearTimeout(timer);
				window.location.replace("AuctionBuyer2.jsp");
			}
		}
...
<body>
	...
	<div id = "container">
        	...
        	<div class="n-bordered td">
                ...
                <tr>
                	<td>
                    	...
                    	<p><hr>Shades</p>
                    	<form action="BuyerForm" onsubmit="" method="post">
						...
						<td>
							<form action="DeleteBid" onsubmit="" method="post" ><input type="submit"   value="Delete Bid" class="area" size="40px"></form>
						</td>
						<td>
							<form action="ViewBids"  method="post" ><input type="submit"   value="View Bids" class="area" size="40px"></form>
						</td>
						<td id="status">
						</td>
					</tr>
		...
		<div id = "footer" style="height: 15%">
	        ...
	        <br><br><br><br><br> Copyright @ OOP Project-Y2-S1-Group 2. 2018-All rights Reserved
		</div>
	</div>
</body>
</html>