...
public class ViewPriceController extends HttpServlet
{
	...
	{
		String sql="select email,pid,minPrice from Seller_info where pid='1000' ";
		...
		try 
		{
			...
			out.println("<th align=\"left\">Minimum Price</th></tr>");
		...
		catch (ClassNotFoundException | SQLException e) 
		{
			...
			out.println("location='AuctionSeller.jsp';");
			out.println("</script>");
		}
